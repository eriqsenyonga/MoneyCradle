...
public class BarGraphExpensesPayee {
	
	Bundle dataBundle;
	Float textSize;
	ConversionClass mCC;

	public BarGraphExpensesPayee(Bundle bundle) {
	...
	public GraphicalView getPayeesExpenseBarView(Context context) {
		...
		CategorySeries series = new CategorySeries("Payee Expenses");
		...
		mRenderer.setChartTitle("TOTAL EXPENSES PER PAYEE");
	...
	public GraphicalView getPayeesExpensePieChartView(Context context) {
		...
		CategorySeries series = new CategorySeries(
				"Payees Total Expenses Pie Chart");
