...
public class BarGraphExpenseAccounts {

	Bundle dataBundle;
	Float textSize;
	ConversionClass mCC;

	public BarGraphExpenseAccounts(Bundle bundle) {
	...
	public GraphicalView getAccountsExpenseBarView(Context context) {
		...
		mRenderer.setChartTitle("TOTAL EXPENSES PER ACCOUNT");
	...
	public GraphicalView getAccountsExpensePieChartView(Context context) {
		...
		CategorySeries series = new CategorySeries(
				"Accounts Total Expenses Pie Chart");
