...
public class BarGraphExpensesCategories {

	Bundle dataBundle;
	Float textSize;
	ConversionClass mCC;

	public BarGraphExpensesCategories(Bundle bundle) {
	...
	public GraphicalView getCategoryExpenseBarView(Context context) {
		...
		CategorySeries series = new CategorySeries("Category Expenses");
		...
		mRenderer.setChartTitle("TOTAL EXPENSES PER CATEGORY");
	...
	public GraphicalView getCategoryExpensePieChartView(Context context) {
		...
		CategorySeries series = new CategorySeries(
				"Categories Total Expenses Pie Chart");
		...
		for (int t = 0; t < lengthValues; t++) {
			...
			r.setColor(Color.rgb(random.nextInt(255), random.nextInt(255),
					random.nextInt(255)));
		...
		Log.d("achart get PIE CHART", "END OF GET PIE CHART Category iNCOME");
